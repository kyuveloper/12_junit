...
public class AssertJTests {
    ...
    * 갖아 직관적이고 편하며, junit5 팀에서도 공식적으로 추천하고 있는 third party lib이다.
    * */
    ...
    * */
    ...
    // 예외 내용이 검증한은 것 또한 예외 타입, 예외 메시지 등을 검증할 수 있다
    @Test
    ...
    void testExceptionValidation() {
        ...
        // when
        Throwable thrown = AssertionsForClassTypes.catchThrowable(()->{throw new IllegalArgumentException("Wrong");});
...
//                .hasMessageContaining("파라미터");
    ...
    * */
    @Test
    @DisplayName("filteringAssertions 테스트 하기")
