...
public class EnvAnnotationTests {
    ...
    * 이 때, 특정 OS에서 무시되는 사유를 disabledReason에 기숭하여
    ...
    * */
    ...
    @Test
    @DisabledOnOs(value = OS.WINDOWS, disabledReason = "윈도우 한경에서는 테스트를 무시합니다.")
    ...
    * cmd에서 set 명령으로 시스템 환경 변수값을 확인해 볼 수 있다.
